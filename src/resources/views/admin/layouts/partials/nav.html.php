...
<div class="app-layout-nav" style="background: #aaa;">
    <div class="app-layout-nav-menu-container">
        ...
        <div>
            <?php if ($adminUser): ?>
                <span style="margin-right: 1rem;"><?= $this->h($adminUser['name']) ?></span>
                <a href="<?= $this->h($this->route('admin.logout')) ?>" onclick="if (confirm('ログアウトしますか？')) document.getElementById('app_nav_logout_form').submit(); return false; ">Logout</a>
