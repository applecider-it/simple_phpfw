...
<div>
    ...
    <div style="display:flex; flex-direction:row; gap:1rem;">
        <button type="submit" class="app-btn-primary" onclick="handle.postJsonTest()">
            Jsonテスト (POST)
        </button>

        <button type="submit" class="app-btn-primary" onclick="handle.getJsonTest()">
            Jsonテスト (GET)
        </button>

        <button type="submit" class="app-btn-primary" onclick="handle.postNosessionJsonTest()">
